...
export default function CreateListing() {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
      <h1 className='text-3xl font-semibold text-center my-7'>Editar una publicación</h1>
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
          ...
          <div className="flex flex-wrap gap-6">
            ...
            <div className="flex items-center gap-2 ">
              ...
              <div className="flex flex-col items-center">
                <p>Precio regular</p>
                {formData.type==='rent' &&<span className='text-sm'>($ / mensuales)</span>}
              </div>
            </div>
            {formData.offer &&
              <div className="flex items-center gap-2 ">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <button disabled={loading ||uploading } className='p-3 bg-slate-700 text-white rounded-lg hover:opacity-95 uppercase'>{loading ?'Editando publicación...':'Editar'}</button>
